...
<body>
    ...
    <main id="main">
        ...
        <section id="profile" class="profile">
            <div class="bootstrap snippets bootdey mx-5">
                <div class="row">
                        ...
                        <div class="panel">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li class="active" style="width: 100%"><a href="#"> <i
                                            class="fa fa-diamond"></i> Donasi Yang Diikuti
                                ...
                                <li style="width: 100%"><a href="/penggalangandanasaya"> <i
                                            class="fa fa-university"></i>
                                        Penggalangan Dana Saya <span class="label pull-right r-activity"
                                            style="background: #008374">{{ $myp->count() }}</span></a></li>
                        ...
                        <section id="progam" class="portfolio sections-bg">
                            <div class="container" data-aos="fade-up">
                                <div class="section-header" style="margin-bottom: -30px">
                                    <h2>Program Donasi Yang Diikuti</h2>
                                    <p>Kita tidak dapat mengubah dunia secara keseluruhan, tetapi kita dapat membuat
                                        perbedaan bagi satu
                                        orang</p>
                                </div>
                                ...
                                <div class="portfolio-isotope" style="margin-top: 15px" data-portfolio-filter="*"
                                    ...
                                    <div class="row gy-4 portfolio-container">
                                        ...
                                        @else
                                            @foreach ($program as $my)
                                                <div class="portfolio-description portfolio-item selesai">
                                                    <div class="portfolio-wrap container" style="width: 100%">
                                                        <div class="portfolio-info my-3">
                                                            <div class="card container py-3 "
                                                                style="border-radius: 5px; background-color: #F1F1F1; max-width: 100%;">
                                                                <div class="row">
                                                                    <div class="col-lg-3">
                                                                        <a href="/detailprogram/{{ $my->program->slug }}" title="Lihat Detail Program">
                                                                        <img src="{{ asset('storage/' . $my->program->gambar) }}"
                                                                            class="img-fluid"
                                                                            style="height: 110px; width: 195px"
                                                                            alt="">
                                                                        </a>
                                                                    </div>
                                                                    <div class="col-lg-8">
                                                                        <a href="/detailprogram/{{ $my->program->slug }}" title="Lihat Detail Program" style="text-decoration: none; color:black">
                                                                            <h4>{{ ucwords($my->program->nama) }}
                                                                            </h4>
                                                                        </a>
                                                                        <span>Kategori :
                                                                            {{ ucwords($my->program->kategori->nama) }}</span>
                                                                        <p>Dana Terkumpul : Rp
                                                                            {{ number_format($my->program->danaskrg, 2, ',', '.') }}
                                                                        </p>
                                                                        <p>Target Dana : Rp
                                                                            {{ number_format($my->program->targetdana, 2, ',', '.') }}
                                                                        </p>
                                                                        <small>Tenggat Program :
                                                                            {{ \Carbon\Carbon::parse($my->program->deadline)->translatedFormat('l, d F Y') }}</small>
                                                                    </div>
                                                                    <div class="col-lg-1">
                                                                        <a href="/donasi/{{ $my->program->slug }}">
                                                                        <i class="bi bi-heart text-success fs-1"
                                                                            title="Donasi Lagi"></i>
                                                                        </a>
                                                                    </div>
                                                                </div>
