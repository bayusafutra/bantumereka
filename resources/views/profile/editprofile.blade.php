                    ...
                    <div class="profile-nav col-md-3">
                        <div class="panel">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li class="active" style="width: 100%"><a href="#"> <i class="fa fa-edit"></i>
                                        Edit
                                        profile</a></li>
                            </ul>
                        </div>
                            ...
                            <div class="col-10 grid-margin stretch-card">
                                ...
                                <div class="card card-5">
                                    <div class="card-heading">
                                        <h2 class="title">Edit Profile Donatur</h2>
                                    </div>
                                    <div class="card-body">
                                        <form method="POST" action="/editprofile" enctype="multipart/form-data">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="value">
                                                    <div class="input-group">
                                                        <input
                                                            class="input--style-5 @error('name') is-invalid @enderror"
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="value">
                                                    <div class="input-group">
                                                        <input
                                                            class="input--style-5 @error('username') is-invalid @enderror"
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="value">
                                                    <div class="input-group">
                                                        <input
                                                            class="input--style-5 @error('notelp') is-invalid @enderror"
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="value">
                                                    <div class="input-group">
                                                        <input
                                                            class="input--style-5 @error('tgllahir') is-invalid @enderror"
                                                            name="tgllahir" style="background-color: #E5E5E5"
                                                            type="date" required
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="value">
                                                    ...
                                                    <small style="color: red">* Abaikan bila tidak ingin mengubah foto profil</small>
                                                    @error('gambar')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
                                                ...
                                                <div class="value">
                                                    <div class="input-group d-flex justify-content-center">
                                                        <button class="btn btn--radius-2"
                                                            ...
                                                            type="submit">Edit Profil</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
