                    ...
                    <div class="profile-nav col-md-3">
                        <div class="panel">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                <li class="active" style="width: 100%"><a href="#"> <i class="fa fa-user"></i>
                                        Profil</a></li>
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body bio-graph-info">
                                ...
                                <div class="row" style="font-size: 14px">
                                    ...
                                    <div class="bio-row">
                                        @if (auth()->user()->tgllahir)
                                            <p><span style="font-weight: 900">Tanggal Lahir </span>:
                                                {{ \Carbon\Carbon::parse(auth()->user()->tgllahir)->translatedFormat('d F Y') }}</p>
                                        @else
                                    ...
                                    <div class="bio-row">
                                        <p><span style="font-weight: 900">Total Saldo </span>: Rp
                                            {{ number_format(auth()->user()->totalsaldo, 2, ',', '.') }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
