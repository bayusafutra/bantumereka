                        ...
                        <div class="panel">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                <li style="width: 100%"><a href="/profile"> <i class="fa fa-user"></i>
                                        Profil</a></li>
                                <li style="width: 100%"><a href="/programyangdiikuti"> <i class="fa fa-diamond"></i> Donasi Yang
                                        Diikuti
                                        <span class="label pull-right r-activity"
                                            style="background: #008374">{{ $program->count() }}</span></a></li>
                                <li style="width: 100%"><a href="/transaksisaya"> <i class="fa fa-handshake-o"></i>
                                ...
                                <li class="active" style="width: 100%"><a href="#"> <i
                                        ...
                                        Penggalangan Dana Saya <span class="label pull-right r-activity"
                                            style="background: #008374">{{ $myprogram->count() }}</span></a></li>
                                        ...
                                        <div class="portfolio-isotope" data-portfolio-filter="*"
                                            ...
                                            <div>
                                                <ul class="portfolio-flters">
                                                    ...
                                                    <li data-filter=".aktif">Aktif</li>
                                                    <li data-filter=".nonaktif">Non AKtif</li>
                                                    <li data-filter=".batal">Batal</li>
                                                    <li data-filter=".selesai">Selesai</li>
                                                </ul>
                                            </div>

                                            <div class="row gy-4 portfolio-container">
                                                @if ($myprogram->count() == 0)
                                                    <h1 class="text-center">Belum ada riwayat donasi</h1>
                                                @else
                                                    @foreach ($myprogram as $my)
                                                        @if ($my->status == 1)
                                                            <div class="portfolio-description portfolio-item pending">
                                                                <div class="portfolio-wrap container"
                                                                    style="width: 100%">
                                                                    <div class="portfolio-info my-3">
                                                                        <a href="/detailprogram/{{ $my->slug }}"
                                                                            style="text-decoration: none; color: black">
                                                                            <div class="card container py-3 "
                                                                                style="border-radius: 5px; background-color: #F1F1F1; max-width: 100%;">
                                                                                <div class="row">
                                                                                    <div class="col-lg-3">
                                                                                        <img src="{{ asset('storage/' . $my->gambar) }}"
                                                                                            class="img-fluid"
                                                                                    ...
                                                                                    <div class="col-lg-8">
                                                                                        ...
                                                                                        <span>Kategori :
                                                                                            {{ ucwords($my->kategori->nama) }}</span>
                                                                                        <p>Target Dana : Rp
                                                                                            {{ number_format($my->targetdana, 2, ',', '.') }}
                                                                                        </p>
                                                                                        <small>Tenggat Program :
                                                                                            {{ \Carbon\Carbon::parse($my->deadline)->translatedFormat('l, d F Y') }}</small>
                                                                                    </div>
                                                                                    <div class="col-lg-1">
                                                                                        <i class="bi bi-clipboard-pulse text-primary fs-1"
                                                                                            title="Pending"></i>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                        ...
                                                        @elseif ($my->status == 2)
                                                            <div class="portfolio-description portfolio-item aktif">
                                                                <div class="portfolio-wrap container"
                                                                    style="width: 100%">
                                                                    <div class="portfolio-info my-3">
                                                                        <a href="/detailprogram/{{ $my->slug }}"
                                                                            ...
                                                                            <div class="card container py-3 "
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-lg-1">
                                                                                        <i class="bi bi-clipboard-plus text-info fs-1"
                                                                                            title="Aktif"></i>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                        ...
                                                        @elseif ($my->status == 3)
                                                            <div class="portfolio-description portfolio-item nonaktif">
                                                                <div class="portfolio-wrap container"
                                                                    style="width: 100%">
                                                                    <div class="portfolio-info my-3">
                                                                        <a href="/detailprogram/{{ $my->slug }}"
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-lg-8">
                                                                                        ...
                                                                                        <small>Tenggat Program :
                                                                                            {{ \Carbon\Carbon::parse($my->deadline)->translatedFormat('l, d F Y') }}</small>
                                                                                            <br>
                                                                                        <span>Pesan Non Aktif :
                                                                                            {{ ucwords($my->pesannonaktif) }}</span>
                                                                                    </div>
                                                                                    <div class="col-lg-1">
                                                                                        <i class="bi bi-clipboard-minus text-warning fs-1"
                                                                                            title="Non Aktif"></i>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                        ...
                                                        @elseif ($my->status == 4)
                                                            <div class="portfolio-description portfolio-item batal">
                                                                <div class="portfolio-wrap container"
                                                                    style="width: 100%">
                                                                    <div class="portfolio-info my-3">
                                                                        <a href="/detailprogram/{{ $my->slug }}"
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-lg-8">
                                                                                        ...
                                                                                        <small>Tenggat Program :
                                                                                            ...
                                                                                            <br>
                                                                                        <span>Pesan Batal :
                                                                                            {{ ucwords($my->pesanbatal) }}</span>
                                                                                    </div>
                                                                                    <div class="col-lg-1">
                                                                                        <i class="bi bi-clipboard-x text-danger fs-1"
                                                                                            title="Batal"></i>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                        ...
                                                        @else
                                                            <div class="portfolio-description portfolio-item selesai">
                                                                <div class="portfolio-wrap container"
                                                                    style="width: 100%">
                                                                    <div class="portfolio-info my-3">
                                                                        <a href="/detailprogram/{{ $my->slug }}"
                                                                            ...
                                                                            <div class="card container py-3 "
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-lg-1">
                                                                                        <i class="bi bi-clipboard-check text-success fs-1"
                                                                                            title="Selesai"></i>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
