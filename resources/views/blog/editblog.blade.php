        ...
        <div class="breadcrumbs">
            ...
            <nav>
                <div class="container">
                    <ol>
                        <li><a href="/">Home</a></li>
                        <li><a href="/detailberita/{{ $berita->slug }}">{{ ucwords($berita->judul) }}</a></li>
                        <li>Edit Berita Program Bantuan</li>
                    </ol>
                </div>
            </nav>
        </div><!-- End Breadcrumbs -->
                    ...
                    <div class="col-9 grid-margin stretch-card">
                        ...
                        <div class="card card-5">
                            <div class="card-heading">
                                <h2 class="title">Edit Berita Donasi</h2>
                            </div>
                            <div class="card-body">
                                <form method="POST" action="/editblog" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="value">
                                            <div class="input-group">
                                                <input type="hidden" name="id" value="{{ $berita->program->id }}">
                                                <input class="input--style-5" name="id_program" type="text"
                                                    placeholder="Judul Berita" readonly
                                                    value="{{ $berita->program->nama }}">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="value">
                                            <div class="input-group">
                                                <input class="input--style-5 @error('judul') is-invalid @enderror"
                                                    ...
                                                    required value="{{ old('judul', ucwords($berita->judul)) }}">
                                            </div>
                                            @error('judul')
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="value">
                                            <div class="input-group">
                                                <textarea name="kontent" id="editor" required>{!! $berita->kontent !!}</textarea>
                                            </div>
                                            @error('kontent')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
    ...
    <script>
        ClassicEditor
            .create(document.querySelector('#editor'), {
                ckfinder: {
                    uploadUrl: '{{ route('editberita') . '?_token=' . csrf_token() }}',
                }
            })
            .catch(error => {
