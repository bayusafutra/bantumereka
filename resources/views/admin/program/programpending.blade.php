...
@section('erga')
    <div class="title mb-4">
          <h1 class="text-center" style="font-family:courier new; font-style: initial;">Pending Program Donasi Bantu Mereka</h1>
    </div>
                ...
                <div class="card-body">
                    <div class="row justify-content-start">
                        <div class="col-lg-6" style="padding-left: 30px">
                            <h4 class="card-title">Data pending program bantuan</h4>
                        </div>
                    </div>
                    <div class="row justify-content-start">
                        <div class="col-lg-6" style="padding-left: 30px">
                            <strong>Jumlah Program Pending : {{ $program->count() }}</strong>
                        </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                @else
                                    ...
                                    <td> {{ $prog->slug  }} </td>
                                        ...
                                        <td>
                                            <a href="/dash-programpending/{{ $prog->slug }}">
                                                <div class="badge badge-outline-warning" style="padding-left: 15px; padding-right: 15px" title="View detail">Pending</div>
                                            </a>
                                        </td>
