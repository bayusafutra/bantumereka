...
@section('erga')
    <div class="title mb-4">
          <h1 class="text-center" style="font-family:courier new; font-style: initial;">Program Aktif Donasi Bantu Mereka</h1>
    </div>
    <div class="row">
        <div class="col-12 grid-margin">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row justify-content-start">
                        <div class="col-lg-6" style="padding-left: 30px">
                            <strong>Jumlah Program Aktif Donasi : {{ $program->count() }}</strong>
                        </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                @else
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-outline-info" type="button" data-bs-toggle="modal" data-bs-target="#{{ $prog->id }}" style="padding-left: 24px; padding-right: 24px" title="ubah status">Aktif</button>
                                        </td>
                                        <td> {{ \Carbon\Carbon::parse($prog->deadline)->translatedFormat('l, d F Y') }} </td>
                                        <td> {{ \Carbon\Carbon::parse($prog->updated_at)->translatedFormat('l, d F Y') }} </td>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content" style="background-color: #2A3038; color:white; border-radius: 1rem; width: 1150px;">
                                                    ...
                                                    <div class="modal-body">
                                                        Apakah anda ingin menonaktifkan program donasi ini?
                                                    </div>
                                                    <form action="/dash-nonaktifprogramaktif" method="post" >
                                                        @csrf
                                                        <div class="hapus d-flex justify-content-center">
                                                            <input type="text" name="pesannonaktif" class="form-control" style="width: 90%; background-color: rgb(9, 16, 52); border-radius: 5px" placeholder="Berikan alasan mengapa anda menonaktifkan program donasi ini!" required>
                                                        </div>
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="submit" class="btn btn-light" style="margin-right: 5px; border-radius: 5px; background-color: rgba(148, 137, 17, 0.361); color: white; padding: 12px 27px 12px 27px">Non Aktifkan</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
